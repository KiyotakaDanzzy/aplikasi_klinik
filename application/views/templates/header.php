        ...
        <div class="main-menu-inner">
            ...
            <div class="menu-body navbar-vertical tab-content" data-simplebar>
                ...
                <div id="menu_antrian" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="antrian-tab">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('antrian/panel_antrian') ?>">Panel Antrian</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('antrian/panel_dokter') ?>">Panel Dokter</a>
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!-- end -->
                <div id="menu_poli" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="poli-tab">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('poli/gigi') ?>">Poli Gigi</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="#">Poli Anak</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="#">Poli Kecantikan</a>
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!-- end -->
                <div id="menu_transaksi" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="transaksi-tab">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('transaksi/pembayaran') ?>">Pembayaran</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('transaksi/riwayat_pembayaran') ?>">Riwayat Pembayaran</a>
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!-- end -->
                <div id="menu_keuangan" class="main-icon-menu-pane tab-pane" role="tabpanel" aria-labelledby="keuangan-tab">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('keuangan/jenis_biaya') ?>">Jenis Biaya</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('keuangan/pemasukan') ?>">Pemasukan</a>
                        </li><!--end nav-item-->
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url('keuangan/pengeluaran') ?>">Pengeluaran</a>
                        </li><!--end nav-item-->
                    </ul><!--end nav-->
                </div><!-- end -->
            </div>
