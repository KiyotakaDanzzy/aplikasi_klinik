<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function getDokterTersedia() {
            ...
            let selectedDokterId = '<?php echo $booking['id_dokter']; ?>';
        ...
        <div class="card-body">
            <form id="form_edit">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            <input type="text" class="form-control" id="nama_pasien_display" value="<?php echo $booking['nama_pasien'] . ' (' . $booking['nik'] . ')'; ?>" readonly required>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10"><input type="text" class="form-control" name="tanggal" id="tanggal" value="<?php echo $booking['tanggal']; ?>" required></div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10"><input type="time" class="form-control" name="waktu" id="waktu" value="<?php echo $booking['waktu']; ?>"></div>
                </div>
                <div class="mb-3 row">
                    <div class="col-sm-10 ms-auto">
                        <button type="button" onclick="edit(event);" class="btn btn-success"><i class="fas fa-save me-2"></i>Simpan</button>
                        <a href="<?php echo base_url(); ?>resepsionis/booking"><button type="button" class="btn btn-warning"><i class="fas fa-reply me-2"></i>Kembali</button></a>
                    </div>
                </div>
            </form>
        </div>
