    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>admin/hak_akses">Hak Akses</a></li>
                    ...
                    <div class="general-label">
                        <form id="form_tambah">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_hak_akses" placeholder="Contoh: Data Pasien" required autocomplete="off">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Link Controller/Method</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="link" placeholder="Contoh: master_data/pasien" required autocomplete="off">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="id_grup_hak_akses" required>
                                        ...
                                        <?php foreach ($grup as $g) { ?>
                                            <option value="<?php echo $g->id; ?>"><?php echo $g->nama_grup_hak_akses; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
