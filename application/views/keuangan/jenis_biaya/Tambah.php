<script type="text/javascript">
    ...
    function tambah(e) {
        ...
        $.ajax({
            url: '<?php echo base_url('keuangan/jenis_biaya/tambah_aksi') ?>',
            method: 'POST',
                ...
                <div class="float-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo base_url(); ?>keuangan/jenis_biaya">Jenis Biaya</a>
                        </li>
                    ...
                    <div class="general-label">
                        <form id="form_tambah">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Input Jenis Biaya" required autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-10 ms-auto">
                                    ...
                                    <a href="<?php echo base_url(); ?>keuangan/jenis_biaya">
