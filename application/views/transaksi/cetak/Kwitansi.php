...
<head>
    ...
    <style>
        ...
        .header .info-klinik h2,
        .header .info-klinik p {
            margin: 0;
        }
        .header .title h1 {
            margin: 0;
    ...
    <div class="container">
        ...
        <div class="info-pasien">
            <div>
                ...
                <p><?php echo $data['pembayaran']['nama_pasien']; ?></p>
            </div>
            <div>
                <strong>Kode Invoice:</strong> <?php echo $data['pembayaran']['kode_invoice']; ?><br>
                <strong>Tanggal:</strong> <?php echo $data['pembayaran']['tanggal']; ?><br>
                <strong>Waktu:</strong> <?php echo $data['pembayaran']['waktu']; ?> WIB<br>
        ...
        <div class="detail">
            <table>
                ...
                <tbody>
                    ...
                    //     $no = 1;
                    //     echo '<tr><td colspan="3"><strong>Resep Obat</strong></td></tr>';
                    ...
                    //     }
                    //     $no_racikan = 1;
                    //     echo '<tr><td colspan="3"><strong>Racikan Obat</strong></td></tr>';
                    //     foreach($data['racikan'] as $item) {
                    //         $subtotal = $item['sub_total_harga'] + $item['sub_total_laba'];
                    //         echo '<tr><td>'.$no_racikan++.'</td><td>'.$item['nama_racikan'].' ('.$item['jumlah'].')</td><td class="text-right">Rp '.number_format($subtotal, 0, '.', ',').'</td></tr>';
                    //     }
                    // }
                    ?>
                </tbody>
        ...
        <div class="summary clearfix">
            <table>
                <tr>
                    ...
                    <td class="text-right"><strong>Rp <?php echo number_format($data['pembayaran']['biaya_tindakan'], 0, '.', ','); ?></strong></td>
                </tr>
                <tr>
                    <td>Bayar</td>
        ...
        <div class="footer">
            ...
            <div>
                <p>Lumajang, <?php echo $data['pembayaran']['tanggal']; ?></p>
                <p>Hormat Kami,</p>
                <br><br><br>
                <p>( Kasir )</p>
            </div>
