<script type="text/javascript">
  ...
  function edit(e) {
    ...
    $.ajax({
      url: '<?php echo base_url('master_data/poli/poli/edit_aksi') ?>',
      method: 'POST',
          ...
          <div class="general-label">
            <form id="form_edit">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="kode" value="<?php echo $row['kode']; ?>" id="kode" placeholder="Input Kode Poli" required>
                </div>
              </div>
              <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label">Nama Poli</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama" value="<?php echo $row['nama']; ?>" id="nama" placeholder="Input Nama Poli" required>
                </div>
              </div>
              <div class="row">
