                    ...
                    <div class="general-label">
                        <form id="form_edit">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama_hak_akses" value="<?php echo $row['nama_hak_akses']; ?>" required autocomplete="off">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Link (Controller/Method)</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="link" value="<?php echo $row['link']; ?>" required autocomplete="off">
                                </div>
                            </div>
                            <div class="mb-3 row">
