<script type="text/javascript">
    ...
    function get_data() {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/level/result_data',
            data: {
                cari
            },
            type: "POST",
                          ...
                          <tr>
                              ...
                              <td>
                                  <div class="text-center">
                                      <a href="<?php echo base_url(); ?>admin/hak_akses/setting/${item.id}">
                                          <button type="button" class="btn btn-shadow btn-sm btn-primary" title="Setting Hak Akses">
                                              <i class="fas fa-key"></i>
                                          </button>
                                      </a>
                                      <a href="<?php echo base_url(); ?>admin/level/view_edit/${item.id}">
                                          <button type="button" class="btn btn-shadow btn-sm btn-info" title="Edit Nama">
                                              <i class="fas fa-pencil-alt"></i>
                                          </button>
                                      </a>
                                      <button type="button" class="btn btn-shadow btn-sm btn-danger" title="Hapus" onclick="hapus(${item.id})">
    ...
    function hapus(id) {
        Swal.fire({
            ...
            text: "Menghapus Level ini akan menghapus semua hak akses terkait!",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo base_url(); ?>admin/level/hapus',
                    method: 'POST',
                    data: {
                        id
                    },
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center pt-3 pb-3">
                    ...
                    <a href="<?php echo base_url(); ?>admin/level/view_tambah">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="cari" placeholder="Cari Nama Level">
                            </div>
                        </div>
                    </div>
