<script type="text/javascript">
    ...
    function edit_entry(e) {
        ...
        $.ajax({
            url: '<?php echo base_url("resepsionis/jadwal_dokter/Jadwal_dokter/edit_entry_aksi"); ?>',
            type: 'POST',
            ...
            <div class="page-title-box">
                <div class="float-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('resepsionis/jadwal_dokter/Jadwal_dokter/detail/' . $dokter['id']); ?>">Detail</a></li>
                        <li class="breadcrumb-item active">Edit Harian</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    <form id="form_edit_entry">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10"><input type="time" class="form-control" id="jam_mulai" name="jam_mulai" value="<?php echo $jadwal_entry['jam_mulai']; ?>" required></div>
                        </div>
                        <div class="mb-3 row">
                            <label for="jam_selesai" class="col-sm-2 col-form-label">Jam Selesai</label>
                            <div class="col-sm-10"><input type="time" class="form-control" id="jam_selesai" name="jam_selesai" value="<?php echo $jadwal_entry['jam_selesai']; ?>" required></div>
                        </div>
                        <div class="row">
                            <div class="col-sm-10 ms-auto">
                                ...
                                <a href="<?php echo base_url('resepsionis/jadwal_dokter/Jadwal_dokter/detail/' . $dokter['id']); ?>" class="btn btn-warning"><i class="fas fa-reply me-2"></i>Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
