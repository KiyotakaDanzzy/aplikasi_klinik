<script type="text/javascript">
    ...
    function tambah(e) {
        e.preventDefault()
        if (!validateForm('#form_tambah')) return;

        $.ajax({
            url: '<?php echo base_url('admin/level/tambah_aksi') ?>',
            method: 'POST',
                ...
                <div class="float-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="<?php echo base_url(); ?>admin/level">Level</a></li>
                ...
                <div class="card-body">
                    <form id="form_tambah">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="nama_level" placeholder="Masukkan Nama Level" required autocomplete="off">
                            </div>
                        </div>
                        <div class="row">
