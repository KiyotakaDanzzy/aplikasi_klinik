<script type="text/javascript">
  ...
  function edit(e) {
    ...
    $.ajax({
      url: '<?php echo base_url('admin/grup_hak_akses/edit_aksi') ?>',
      method: 'POST',
        ...
        <div class="float-end">
          <ol class="breadcrumb">
            <li class="breadcrumb-item">
              <a href="<?php echo base_url(); ?>admin/grup_hak_akses">Grup Hak Akses</a>
            </li>
          ...
          <div class="general-label">
            <form id="form_edit">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nama_grup" id="nama_grup" value="<?php echo $row['nama_grup_hak_akses']; ?>" required autocomplete="off">
                </div>
              </div>
              <div class="row">
