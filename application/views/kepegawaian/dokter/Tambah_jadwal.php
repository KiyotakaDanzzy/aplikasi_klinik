                ...
                <div class="card-body">
                    <form id="form_tambah_hari">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="jam_mulai" id="jam_mulai" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="jam_selesai" class="col-sm-2 col-form-label">Jam Selesai</label>
                            <div class="col-sm-10">
                                <input type="text" name="jam_selesai" id="jam_selesai" class="form-control" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="row">
