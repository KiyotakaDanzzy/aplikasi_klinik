<script type="text/javascript">
  ...
  function edit(e) {
    ...
    $.ajax({
      url: '<?php echo base_url('kepegawaian/dokter/edit_aksi') ?>',
      method: 'POST',
          ...
          <div class="general-label">
            <form id="form_edit">
              ...
              <div class="mb-3 row"><label for="id_pegawai" class="col-sm-2 col-form-label">Pegawai (Dokter)</label>
                <div class="col-sm-10"><select class="form-control" name="id_pegawai" id="id_pegawai" required>
                    <option value="">Pilih Pegawai</option><?php foreach ($data_pegawai as $pegawai) {
                                                              $selected = ($pegawai->id == $row['id_pegawai']) ? 'selected' : '';
              ...
              <div class="row">
                <div class="col-sm-10 ms-auto"><button type="button" onclick="edit(event);" class="btn btn-success"><i class="fas fa-save me-2"></i>Simpan</button><a href="<?php echo base_url(); ?>kepegawaian/dokter"><button type="button" class="btn btn-warning"><i class="fas fa-reply me-2"></i>Kembali</button></a></div>
              </div>
            </form>
          </div>
        </div>
